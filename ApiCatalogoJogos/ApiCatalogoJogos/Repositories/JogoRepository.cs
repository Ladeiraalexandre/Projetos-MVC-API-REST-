...
namespace ApiCatalogoJogos.Repositories
{
    public class JogoRepository : IJogoRepository
    {
        ...
        {
            //como esta usando a paginação(com link), o skip faz com que se pule a quantidade que vc quer. Ex: qtd = 5 por pagina. Então ve a pagina pula 5 e depois pega 5(take). Seriam 5 jogos por pagina
        ...
        public Task<Jogo> ObterPorId(Guid id)
        {
            ...
            return Task.FromResult(jogos[id]);//esse task.fromresult, como não tem um BD, ele cria uma task e retorna com o objeto que esta passando e retorna
        }
